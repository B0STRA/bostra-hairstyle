...
function SetPlayerHair(player, newStyle)
	SetPedComponentVariation(player,2,GetPedDrawableVariation(player,2)==newStyle and OriginalHairStyle[player]or newStyle,0,0)
end
...
function StartScene()
	...
	AttachEntityToEntity(propObject,PlayerPedId(),71,0.108244000122,-0.025791563607893,-0.036832240932658,-56.874661452405,62.478464465016,-4.3258342327393,true,true,false,true,1,true)
	...
	local particleFx = StartParticleFxLoopedOnEntity("ent_amb_steam",propObject,0.0,0.0,0.145,40.0,91.0277,0.0,1.0,false,false,false)
